        ...
        return (
            <View style={{ flex: 1 }}>
                <View style={{ height: height(100), width: width(100), backgroundColor: '#99cc00', borderBottomLeftRadius: 40, borderBottomRightRadius: 40, shadowOpacity: 5, shadowColor: 'grey', shadowRadius: 5 }}>
                    ...
                    <View style={{ height: height(15), width: width(90), backgroundColor: '#99cc00', alignSelf: 'center', marginTop: 20, borderRadius: 10, borderWidth: 2, borderColor: '#fff' }}>
                        <View style={{ height: height(3), width: width(25), backgroundColor: '#99cc00', marginTop: -15, marginLeft: 30 }}>
                            <Text style={{ fontSize: 18, color: '#fff', }}>Add remarks</Text>
                        </View>
                        <View style={{ height: height(3), width: width(70), backgroundColor: '#99cc00', marginTop: 5, marginLeft: 30 }}>
                            <Text style={{ fontSize: 18, color: '#fff', }}>e.g  without tomatoes, salsa etc </Text>
                        </View>
                        <View style={{height: height(5), width: width(50),flexDirection:'row', marginTop: 40, alignSelf:'flex-end' }}>
                            <TouchableOpacity style={{height:height(5), width:width(25), justifyContent:'center', }}>
                                <Text style={{fontSize:20, textAlign:'center', color:'#fff'  }}>Done</Text>
                            </TouchableOpacity>
                            <TouchableOpacity style={{height:height(5), width:width(25), justifyContent:'center', }}>
                                <Text style={{fontSize:20, textAlign:'center',color:'#fff'  }}>Delete</Text>
                            </TouchableOpacity>
                        </View>
                    </View>
                    <View style={{ height: height(8), width: width(85), backgroundColor: '#f2f2f2', marginTop: 10, borderRadius: 10, alignSelf: 'center', flexDirection: 'row' }}>
                        <TextInput
                    ...
                    <View style={{ height: height(25), width: width(90), alignSelf: 'center', marginTop: 10, justifyContent: 'center' }}>
                        <View style={{ height: height(12), width: width(90), flexDirection: 'row', }}>
                            <View style={{ height: height(12), width: width(55), marginLeft: 20 }}>
                                <Text style={{ fontSize: 25, fontWeight: 'normal', color: 'white', marginVertical: 2 }}> Cart Total </Text>
                                <Text style={{ fontSize: 25, fontWeight: 'normal', color: 'white', marginVertical: 2 }}> Delivery </Text>
                                <Text style={{ fontSize: 25, fontWeight: 'normal', color: 'white', marginVertical: 2 }}> Promo Diacount</Text>
                            </View>
                            <View style={{ height: height(12), width: width(25), alignItems: 'flex-end' }}>
                                <Text style={{ fontSize: 25, fontWeight: 'bold', color: 'white', marginVertical: 2 }}> 7.80 </Text>
                                <Text style={{ fontSize: 25, fontWeight: 'bold', color: 'white', marginVertical: 2 }}> Free </Text>
                                <Text style={{ fontSize: 25, fontWeight: 'bold', color: 'white', marginVertical: 2, }}> -</Text>
                            </View>
                        </View>
                        ...
                        <View style={{ height: height(5), width: width(90), flexDirection: 'row', }}>
                            <View style={{ height: height(5), width: width(55), marginLeft: 20 }}>
                                <Text style={{ fontSize: 25, fontWeight: 'normal', color: 'white', marginVertical: 2 }}> SubTotal </Text>
                            </View>
                            <View style={{ height: height(5), width: width(25), alignItems: 'flex-end' }}>
                                <Text style={{ fontSize: 25, fontWeight: 'bold', color: 'white', marginVertical: 2, }}> 7.90</Text>
                            </View>
                        </View>
                    ...
                    <View style={{ height: height(6), width: width(50), backgroundColor: '#f2f2f2', justifyContent: 'center', alignSelf: 'center', marginTop: 5, borderRadius: 10 }}>
