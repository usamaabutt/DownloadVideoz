...
class Cart extends Component {
    ...
    render() {
        return (
            <View style={{ flex: 1 }}>
                <View style={{ height: height(95), width: width(100), backgroundColor: '#99cc00', borderBottomLeftRadius: 40, borderBottomRightRadius: 40, shadowOpacity: 5, shadowColor: 'grey', shadowRadius: 5 }}>
                    ...
                    <View style={{ height: height(10), width: width(90), alignSelf: 'center' }}>
                        <Text style={{ fontSize: 30, color: 'white', textAlign: 'center', }}> Order Method</Text>
                    ...
                    <View style={{height:height(6), width:width(50), backgroundColor:'#f2f2f2',justifyContent:'center', alignSelf:'center', marginTop:10, borderRadius:10}}>
