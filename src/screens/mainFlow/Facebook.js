...
class Facebook extends Component {
    ...
    render() {
        return (
            <View style={{ flex: 1 }}>
                <View style={{ height: height(8), width: width(100), backgroundColor: '#292f4a', marginTop: 50, flexDirection: 'row', alignItems: 'center', justifyContent: 'center' }}>
                ...
                <View style={{ height: height(50), width: width(90), alignSelf:'center',backgroundColor:'white', justifyContent: 'center', marginTop: 50, borderWidth:0.5 ,borderColor:'lightgrey' }}>
                    <View >
                        <Text style={{ fontSize: 25, justifyContent: 'center', color: 'black',textAlign:'center' }}>Download High Quailty Videos from Facebook</Text>
                        <Text style={{ fontSize: 12, justifyContent: 'center', color: 'black', marginTop: 20,textAlign:'center', marginLeft: 2 }}>Copy here the URL of your video (Facebook)</Text>
                    </View>
                    <TextInput
                    ...
                    />
                    <View style={{ height: height(5), width: width(80), backgroundColor: '#292f4a', marginTop: 20, alignSelf: 'center', borderRadius: 2 }}>
                        <Button
                            title="Download"
                            color='white'
                            alignItems='center'
